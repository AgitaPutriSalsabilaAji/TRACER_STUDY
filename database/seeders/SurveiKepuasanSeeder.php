    ...
    public function run()
    {
        ...
        foreach ($lulusan as $lulusanData) {
            ...
            SurveiKepuasan::create([
                ...
                'email' => $faker->email(), 
                'ketjasama_tim' => $faker->randomElement([1, 2, 3, 4, 5]),
                'keahlian_u' => $faker->randomElement([1, 2, 3, 4, 5]),
                'kemampuan_bahasa_asing' => $faker->randomElement([1, 2, 3, 4, 5]),
                'kemampuan_komunikasi' => $faker->randomElement([1, 2, 3, 4, 5]),
                'pengembangan_diri' => $faker->randomElement([1, 2, 3, 4, 5]),
                'kepemimpinan' => $faker->randomElement([1, 2, 3, 4, 5]),
                'etos_kerja' => $faker->randomElement([1, 2, 3, 4, 5]),
