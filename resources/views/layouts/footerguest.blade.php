        ...
        <div class="row">
            ...
            <div class="col-md-5 mb-4 mb-md-0">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="#" class="text-muted fs-5"><i class="fab fa-tiktok"></i></a>
            ...
            <div class="col-md-4 mb-3 mb-md-0">
                <h6 class="text-uppercase fw-bold text-muted">Alamat</h6>
            ...
            <!-- Kontak -->
            <div class="col-md-3">
                <h6 class="text-uppercase fw-bold text-muted">Kontak</h6>
