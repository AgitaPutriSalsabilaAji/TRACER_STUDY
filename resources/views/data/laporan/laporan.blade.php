                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card bg-white text-dark shadow-sm">
                                <div class="card-body">
                                    ...
                                    <button class="downloadExcel btn btn-success btn-sm" data-route="{{ route('laporan.export.tracer') }}">Download Laporan</button>  
                                </div>
                            </div>
                        </div>
                        {{-- Card 2 --}}
                        <div class="col-md-6 mb-3">
                            <div class="card bg-white text-dark shadow-sm">
                                <div class="card-body">
                                    ...
                                    <button class="downloadExcel btn btn-success btn-sm" data-route="{{ route('laporan.export.kepuasan') }}">Download Laporan</button>
                                </div>
                            </div>
                        </div>
                        {{-- Card 3 --}}
                        <div class="col-md-6 mb-3">
                            <div class="card bg-white text-dark shadow-sm">
                                <div class="card-body">
                                    ...
                                    <button class="downloadExcel btn btn-success btn-sm" data-route="{{ route('laporan.export.belumTracer') }}">Download Laporan</button>                                </div>
                            </div>
                        </div>
                        {{-- Card 4 --}}
                        <div class="col-md-6 mb-3">
                            <div class="card bg-white text-dark shadow-sm">
                                <div class="card-body">
                                    ...
                                    <button class="downloadExcel btn btn-success btn-sm" data-route="{{ route('laporan.export.belumSurvei') }}">Download Laporan</button> 
                                </div>
                            </div>
                        </div>
                    </div> {{-- /.row --}}
